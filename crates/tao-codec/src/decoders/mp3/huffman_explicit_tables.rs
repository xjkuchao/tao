//! MP3 Huffman 显式码表 (来自 symphonia-bundle-mp3 0.5.5)。
//! 用于 Big Values 表 1..31 的精确码字映射。

#[rustfmt::skip]
pub const MPEG_CODES_1: [u32; 4] = [
    0x0001, 0x0001, 0x0001, 0x0000,
];

#[rustfmt::skip]
pub const MPEG_BITS_1: [u8; 4] = [
    1,  3,  2,  3,
];

#[rustfmt::skip]
pub const MPEG_CODES_2: [u32; 9] = [
    0x0001, 0x0002, 0x0001, 0x0003, 0x0001, 0x0001, 0x0003, 0x0002,
    0x0000,
];

#[rustfmt::skip]
pub const MPEG_BITS_2: [u8; 9] = [
    1,  3,  6,  3,  3,  5,  5,  5,
    6,
];

#[rustfmt::skip]
pub const MPEG_CODES_3: [u32; 9] = [
    0x0003, 0x0002, 0x0001, 0x0001, 0x0001, 0x0001, 0x0003, 0x0002,
    0x0000,
];

#[rustfmt::skip]
pub const MPEG_BITS_3: [u8; 9] = [
    2,  2,  6,  3,  2,  5,  5,  5,
    6,
];

#[rustfmt::skip]
pub const MPEG_CODES_5: [u32; 16] = [
    0x0001, 0x0002, 0x0006, 0x0005, 0x0003, 0x0001, 0x0004, 0x0004,
    0x0007, 0x0005, 0x0007, 0x0001, 0x0006, 0x0001, 0x0001, 0x0000,
];

#[rustfmt::skip]
pub const MPEG_BITS_5: [u8; 16] = [
    1,  3,  6,  7,  3,  3,  6,  7,
    6,  6,  7,  8,  7,  6,  7,  8,
];

#[rustfmt::skip]
pub const MPEG_CODES_6: [u32; 16] = [
    0x0007, 0x0003, 0x0005, 0x0001, 0x0006, 0x0002, 0x0003, 0x0002,
    0x0005, 0x0004, 0x0004, 0x0001, 0x0003, 0x0003, 0x0002, 0x0000,
];

#[rustfmt::skip]
pub const MPEG_BITS_6: [u8; 16] = [
    3,  3,  5,  7,  3,  2,  4,  5,
    4,  4,  5,  6,  6,  5,  6,  7,
];

#[rustfmt::skip]
pub const MPEG_CODES_7: [u32; 36] = [
...
#[rustfmt::skip]
pub const MPEG_CODES_10: [u32; 64] = [
...
#[rustfmt::skip]
pub const MPEG_CODES_11: [u32; 64] = [
...
#[rustfmt::skip]
pub const MPEG_CODES_12: [u32; 64] = [
...
#[rustfmt::skip]
pub const MPEG_CODES_13: [u32; 256] = [
...
#[rustfmt::skip]
pub const MPEG_CODES_15: [u32; 256] = [
...
#[rustfmt::skip]
pub const MPEG_CODES_16: [u32; 256] = [
...
#[rustfmt::skip]
pub const MPEG_CODES_24: [u32; 256] = [
