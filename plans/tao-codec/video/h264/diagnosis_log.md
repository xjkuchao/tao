...
## 当前基线(10 帧, 2026-02-22, 16 样本全覆盖)

| 样本 | 分辨率    | Profile              | 精度    | Y-PSNR  | max_err | 状态 |
| ---- | --------- | -------------------- | ------- | ------- | ------- | ---- |
| C1   | 1280x720  | Constrained Baseline | 0.473%  | 11.96dB | 254     | 失败 |
| C2   | 1920x1080 | Main                 | 33.333% | 0.56dB  | 239     | 通过 |
| C3   | 704x480   | High                 | 19.348% | 8.84dB  | 240     | 通过 |
| E1   | 352x200   | Baseline             | 0.970%  | 16.25dB | 252     | 失败 |
| E2   | 1280x720  | Main                 | 23.118% | 1.78dB  | 241     | 通过 |
| E3   | 640x352   | Main                 | 32.374% | 8.23dB  | 234     | 通过 |
| E4   | 480x204   | Main                 | 1.414%  | 9.63dB  | 246     | 通过 |
| E5   | 1920x1088 | Main                 | 0.530%  | 12.95dB | 239     | 失败 |
| E6   | 1920x1080 | High                 | 27.894% | 7.14dB  | 116     | 通过 |
| E7   | 1920x1080 | High                 | 0.493%  | 12.35dB | 244     | 失败 |
| E8   | 352x288   | High                 | 7.105%  | 16.82dB | 212     | 通过 |
| E9   | 352x200   | Baseline             | 0.915%  | 17.17dB | 142     | 失败 |
| X1   | 352x288   | High                 | 1.595%  | 8.17dB  | 255     | 通过 |
| X2   | 352x288   | High                 | 0.575%  | 6.75dB  | 253     | 失败 |
| X3   | 352x288   | High                 | 0.684%  | 7.52dB  | 255     | 失败 |
| X4   | 352x288   | High                 | 5.029%  | 10.56dB | 254     | 通过 |

- 通过: 9/16, 失败: 7/16 (阈值 1.00%)
- 所有 16 个样本均可成功解码和对比, 无基础设施错误
- 失败样本均为精度不足, 需在后续阶段修复
